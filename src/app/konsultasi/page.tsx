...
const consultationPackages = [
  {
    title: 'Konsultasi 1 on 1 Online',
    sessions: [
      { label: '1x @1 Jam', price: 'Rp 149.000' },
      { label: '3x @1 Jam', price: 'Rp 399.000' },
      { label: 'Paket Bulanan', price: 'Rp 450.000' },
    ],
  },
]
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white">
      ...
      <section className="pt-40 pb-24 px-6">
        <div className="max-w-5xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-purple-500/10 border border-purple-500/20 rounded-full mb-8">
            ...
            <span className="text-purple-300 text-sm font-medium">Layanan Konsultasi Riset</span>
          </div>
          <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">
            Temukan Solusi Terbaik<br />untuk Beragam Penelitian
          </h1>
          <p className="text-xl text-gray-400 mb-10 max-w-2xl mx-auto">
            Butuh bimbingan langsung dari ahlinya? Tim konsultan kami siap membantu Anda melewati setiap tahapan penelitian.
          </p>
          <Link
            href="https://s.id/KonsultasiGipsy"
            target="_blank"
      ...
      <section className="py-20 px-6 bg-gray-900/50">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Paket Konsultasi</h2>
            <p className="text-gray-400 text-lg">Pilih paket yang sesuai dengan kebutuhan Anda</p>
          </div>
          <div className="grid md:grid-cols-3 gap-6">
            {consultationPackages[0].sessions.map((pkg) => (
              <div key={pkg.label} className="bg-gray-900 border border-gray-800 rounded-2xl p-8 text-center">
                <div className="text-lg font-bold mb-2">{pkg.label}</div>
                <div className="text-3xl font-bold text-purple-400 mb-6">{pkg.price}</div>
                <Link
                  href="https://s.id/konsultasi1on1-gipsy"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="block py-3 bg-purple-600 hover:bg-purple-700 rounded-xl font-medium transition"
                >
                  Pesan Sekarang
                </Link>
              </div>
      ...
      <section className="py-20 px-6">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Kata Mereka yang Sudah Konsultasi</h2>
          </div>
      ...
      <section className="py-20 px-6">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-gray-400 text-lg mb-8">Hubungi kami sekarang dan dapatkan konsultasi pertama Anda.</p>
          <Link
            href="https://s.id/KonsultasiGipsy"
            target="_blank"
            rel="noopener noreferrer"
