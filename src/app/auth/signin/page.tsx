  ...
  return (
    <div className="bg-gray-900 border border-gray-800 rounded-2xl p-8">
      ...
      <button
        ...
        className="w-full py-3 bg-white hover:bg-gray-100 disabled:bg-gray-100/50 rounded-xl font-medium text-gray-900 transition flex items-center justify-center gap-3 mb-4"
      >
        ...
        {loadingGoogle ? 'Memuat...' : 'Masuk dengan Google'}
      </button>
      ...
      <div className="bg-gray-800/50 rounded-xl p-4 mt-6">
        <p className="text-sm text-gray-400">
          <span className="text-purple-400 font-medium">💡 Tips:</span> Link masuk akan dikirim dalam beberapa menit. 
      ...
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          <Link href="/" className="inline-flex items-center gap-2">
            ...
            <span className="text-2xl font-bold">GipsyAI</span>
          </Link>
        </div>
